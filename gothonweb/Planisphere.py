...
class Room(object):
    def __init__(self, name, description, hints):
        self.name = name
...
""", "either shoot, dodge or tell a joke")
...
""", "either throw the bomb or slowly place the bomb.")
...
""", "a single digit no. Invalid input is instant death.")
...
central_corridor.add_paths({
    'shoot' : generic_death_ccs,
    'dodge' : generic_death_ccd,
...
the_bridge.add_paths({
    'throw the bomb' : generic_death_tb,
